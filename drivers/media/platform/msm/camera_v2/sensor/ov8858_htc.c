...
#define ov8858_SENSOR_NAME "ov8858_htc"
#define PLATFORM_DRIVER_NAME "msm_camera_ov8858_htc"
...
static const struct of_device_id ov8858_dt_match[] = {
	{.compatible = "htc,ov8858_htc", .data = &ov8858_s_ctrl},
	{}
};
...
static const char *ov8858NAME = "ov8858_htc";
...
//HTC_END
		...
		cdata->af_value.AF_INF_LSB = otp[0x9];
		cdata->af_value.AF_MACRO_MSB = otp[0xA];
		cdata->af_value.AF_MACRO_LSB = otp[0xB];
