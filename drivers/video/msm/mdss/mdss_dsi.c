...
static void mdss_dsi_enable_force_clock_hs(struct mdss_panel_data *pdata){
	struct mipi_panel_info *mipi;
	struct mdss_dsi_ctrl_pdata *ctrl_pdata = NULL;
...
static void mdss_dsi_disable_force_clock_hs(struct mdss_panel_data *pdata){
	struct mipi_panel_info *mipi;
	struct mdss_dsi_ctrl_pdata *ctrl_pdata = NULL;
				  ...
				  int event, void *arg)
{
	...
	case MDSS_EVENT_PANEL_ON:
		...
		mdss_dsi_enable_force_clock_hs(pdata); 
	...
	case MDSS_EVENT_PANEL_OFF:
		...
		if (ctrl_pdata->off_cmds.link_state == DSI_LP_MODE)
			rc = mdss_dsi_blank(pdata, power_state);
		mdss_dsi_disable_force_clock_hs(pdata); 
