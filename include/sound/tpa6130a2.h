...
struct tpa61xx_config_data {
	unsigned int mode_num;
	struct amp_comm_data cmd_data[TPA6130_MODE_NUM];  /* [mode][mode_kind][reserve][cmds..] */
};
...
#define TPA6130_SET_PARAM       _IOW(AMP_IOCTL_MAGIC, 0x01, struct tpa61xx_config_data)
